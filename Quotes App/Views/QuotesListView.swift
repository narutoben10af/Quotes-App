                                    ...
                                    label:
                                        {
                                            ZStack
                                            {
                                                Image(quote.image).resizable().aspectRatio(contentMode: .fill).frame(width: geo.size.width, height: geo.size.height/2, alignment: .center).cornerRadius(20).clipped().padding(.vertical).shadow(radius: 10)
